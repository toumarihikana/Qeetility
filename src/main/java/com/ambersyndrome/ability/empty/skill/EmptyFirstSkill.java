package com.ambersyndrome.ability.empty.skill;
...
public class EmptyFirstSkill extends Skill {

    public static final Skill instance = new EmptyFirstSkill();
    public EmptyFirstSkill() {
        super("empty-1", 1);
    }
    ...
    public static class EmptyFirstContext extends Context
    {
        ...
        public EmptyFirstContext(EntityPlayer player)
        {
            super(player, EmptyFirstSkill.instance);
        }
...
//                                    ACAdvancements.trigger(player, ACAdvancements.ac_milestone.ID);
    ...
    @RegClientContext(EmptyFirstContext.class)
    public static class ArcGenContextC extends ClientContext
    {
        public ArcGenContextC(EmptyFirstContext par)
        {
            super(par);

        }

        @NetworkMessage.Listener(channel= EmptyFirstContext.MSG_EFFECT, side=Side.CLIENT)
